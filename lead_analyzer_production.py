...
with main_tab2:
    ...
    # File upload
        ...
        if ads_file is not None:
            ...
            st.info("👆 Upload your ad group report to get started")

            with st.expander("📖 How to Export from Google Ads"):
                st.markdown("""
                1. Go to **Reports** → **Predefined Reports** → **Ad Group**
                2. Click **Columns** button
                3. Add these columns:
                   - Ad group, Campaign, Ad group status
                   - Impr., Clicks, Cost, Avg. CPC, CTR
                   - **Search impr. share**
                   - **Search top IS**
                   - **Search abs. top IS**
                   - **Search lost IS (rank)**
                   - Conversions, Cost / conv. (optional)
                4. Set date range and click **Download**
